...
/opt/riscv/bin/riscv64-unknown-linux-gnu-gcc -march=rv32i_zbb_zbc_zbkb_zbkc_zbkx_zknd_zkne_zknh_zksed_zksh -mabi=ilp32 -D USE_RISCV_ACCEL aes_dir/aes_filesv2/testv4.c -static -o aes_acc
