...
/opt/riscv/bin/riscv64-unknown-linux-gnu-gcc -march=rv32imac_zba_zbb_zbkb_zbkc_zbkx_zksh_zknh -mabi=ilp32 -D USE_RISCV_CRYPTO_EXT sha_dir/sha_filesv2/testv2.c -static -o sha_acc
